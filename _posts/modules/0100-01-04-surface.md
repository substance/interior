...
Substance Surface has been designed out of the need. It's designed to stricly separate content (plain-text) from annotations (data that sticks on text ranges).
