...
Calling `getAnnotations` without a parameter gives you all registered annotations. You can optionally look at a specific text `selection` and optionally filter by annotation `types`.
...
### Delete annotation
	...
	`surface.deleteAnnotation(annotation);`
